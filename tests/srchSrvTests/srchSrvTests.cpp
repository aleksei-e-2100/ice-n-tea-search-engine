...
TEST(TestSearchServer, TestBasic_2) 
{
    ...
    * Например:
    * ожидается {0, 0.666667}, {1, 0.666667}, {2, 0.666667},
    * а резузультат будет {0, 0.666667}, {2, 0.666667}, {3, 0.666667}
    * Поэтому последние три ответа проверим только по релевантности,
    * присвоив doc_id значение 100
    */

    const vector<vector<RelativeIndex>> expected = 
    {
        {{7, 1}, {14, 1}, {100, 0.6666666666666666}, {100, 0.6666666666666666}, {100, 0.6666666666666666}}
    };
